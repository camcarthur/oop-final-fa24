...
# should only need to run once. each time this is ran it will delete the existing database and create a new one
...
def create_database_and_user():
    try:
        ...
        cursor.execute(f"CREATE USER {NEW_USER} WITH PASSWORD '{NEW_PASSWORD}';") # creates user
